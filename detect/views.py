...
def predict(request):
    ...
    if request.method == 'POST':
            ...
            if not helmet_found:
                ...
                for plate_box in license_plate_boxes:
                    if is_inside(plate_box, rider_box):
                        ...
                        plate_img.save(f"C:/Users/Prajwal/Downloads/LicensePlate/lpUI/LP_CROPS/rider_{rider_count}_plate.jpg")
        ...
        plate_image_path = "C:/Users/Prajwal/Downloads/LicensePlate/lpUI/LP_CROPS/rider_1_plate.jpg"  # Adjust the path accordingly

        # Read text from the license plate image
        result = reader.readtext(plate_image_path)

        platereading="Found Riders with no helmet :  "
        reading=''

        for detections in result:
            reading+=detections[1]
        ...
        print("platereading",platereading)
        # Render results
        params = {'img_pth': latest_image_path,'plate':platereading}
